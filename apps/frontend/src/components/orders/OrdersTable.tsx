...
const ALL_COLUMNS: ColumnDef[] = [
  ...
  { id: 'checkerNote', label: 'הערת בודק', align: 'right' },
  { id: 'items', label: 'פריטים', sortKey: 'orderLines.length', align: 'right' },
  { id: 'pallets', label: 'משטחים', sortKey: 'palletCount', align: 'right' },
