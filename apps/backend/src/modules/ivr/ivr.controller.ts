...
const STATIC_MESSAGES = {
  confirm_prompt: 'לאישור המשלוח לְחַץ 1, לסירוב לְחַץ 2, לשמיעה חוזרת לְחַץ 3',
...
function buildOrderMessage(order: {
  ...
  return `שלום, כאן חברת פֶרְפֶקְט לָיין. המשלוח שלך לכתובת ${address}, מתוכנן לתאריך ${day} ב${monthName}, ביום ${weekday}, בשעות ${timeWindow}`;
}
